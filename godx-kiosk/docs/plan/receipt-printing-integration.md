...
Reference implementation: [`receipt_print/src/screens/WebViewReceiptScreen.tsx`](../../../receipt/receipt_print/src/screens/WebViewReceiptScreen.tsx) — đây là màn hình duy nhất của project demo hoạt động đúng kỳ vọng.
...
**File**: `godx-kiosk/src/types/kiosk.ts`
...
Port nội dung từ [`thermal.blade.php`](../../../receipt/receipt-api/resources/views/receipts/thermal.blade.php) sang TypeScript template literal.
...
- [`receipt_print/src/screens/WebViewReceiptScreen.tsx`](../../../receipt/receipt_print/src/screens/WebViewReceiptScreen.tsx) — reference implementation
- [`receipt-api/resources/views/receipts/thermal.blade.php`](../../../receipt/receipt-api/resources/views/receipts/thermal.blade.php) — template gốc cần port
- [`receipt_print/src/utils/printer.ts`](../../../receipt/receipt_print/src/utils/printer.ts) — printer wrapper reference
- [`godx-kiosk/src/lib/printer.ts`](../../src/lib/printer.ts) — printer utilities hiện có của kiosk
- [`godx-kiosk/docs/settings-screen-plan.md`](../settings-screen-plan.md) — plan trước về Settings screen + printer config
...
#### Frontend — Files mới
- [`src/lib/receipt-types.ts`](../../src/lib/receipt-types.ts) — interface `ReceiptData`, `ReceiptItem`, `ReceiptStore`, `ReceiptSplitInfo`
- [`src/lib/receipt-template.ts`](../../src/lib/receipt-template.ts) — `buildReceiptHtml(data): string`, port từ Blade template
- [`src/lib/receipt-data-builder.ts`](../../src/lib/receipt-data-builder.ts) — `buildReceiptData({ order, payment, store, splitInfo })`
- [`src/components/hidden-receipt-canvas.tsx`](../../src/components/hidden-receipt-canvas.tsx) — WebView ẩn off-screen + measure height
- [`src/hooks/use-receipt-printer.ts`](../../src/hooks/use-receipt-printer.ts) — orchestration: render → capture → in
