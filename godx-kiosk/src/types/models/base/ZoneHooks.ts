...
import type { ZoneFilters, ZoneBaseServiceType } from "./ZoneService";
import type { createZoneQueryKeys } from "./ZoneQueryKeys";

export function createZoneBaseHooks(
  service: ZoneBaseServiceType,
  keys: ReturnType<typeof createZoneQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: ZoneFilters = {}) =>
      useQuery({
