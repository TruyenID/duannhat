...
import type { ProductFilters, ProductBaseServiceType } from "./ProductService";
import type { createProductQueryKeys } from "./ProductQueryKeys";

export function createProductBaseHooks(
  service: ProductBaseServiceType,
  keys: ReturnType<typeof createProductQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: ProductFilters = {}) =>
      useQuery({
