import { Badge, Dialog, DialogContent, DialogHeader, DialogTitle, toast } from "@godxjp/ui/admin";
...
export function Sync() {
  ...
  async function retryFailed() {
    try {
      ...
      toast.success(t("sync.retry_queued", { count: result.count }));
      loadData();
    } catch (err) {
      console.error(err);
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <Badge tone={syncInfo?.status === "online" ? "success" : undefined}>
