...
> Mọi đường dẫn trỏ tới file source code của workstation, tương đối từ gốc repo (`workstation/...`).
...
| HQ catalog write (product CRUD) | Không phục vụ POS — chỉ web/admin/HQ |
