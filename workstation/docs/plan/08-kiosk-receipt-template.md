...
| **Admin-web** (UI set) | Input `taxRate` per-shop, lưu OK | [shop/[shopSlug]/settings/page.tsx:489](../../../web/admin/src/app/shop/[shopSlug]/settings/page.tsx#L489) |
...
- `app/kiosk/src/lib/receipt-types.ts` — `ReceiptSplitInfo` (port split logic sang Go)
- `app/kiosk/app/success.tsx`, `app/kiosk/src/lib/printer.ts` — bỏ in trực tiếp
