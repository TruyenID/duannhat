...
- Print receipt — kiosk đã có ``react-native-star-io10`` in **trực tiếp** qua TCP. Không qua workstation.
...
**Files:**
- Modify: `app/kiosk/package.json`
- Modify: `app/kiosk/app.json` (Expo config plugin)
- Auto: `app/kiosk/ios/Info.plist`, `app/kiosk/android/app/src/main/AndroidManifest.xml`
...
**Files:**
- Create: `app/kiosk/src/services/workstation/discovery.ts`
- Create: `app/kiosk/src/services/workstation/base-url-resolver.ts`
- Create: `app/kiosk/src/services/workstation/types.ts`
...
**Files:**
- Modify: `app/kiosk/src/lib/api.ts` (có `apiFetch`)
- Create: `app/kiosk/src/services/workstation/socket.ts`
- Create: `app/kiosk/src/providers/workstation-provider.tsx`
- Modify: `app/kiosk/src/app/_layout.tsx`
...
**Files:**
- Modify: `app/kiosk/src/app/settings.tsx`
- Create: `app/kiosk/src/components/workstation-status-banner.tsx`
- Modify: `app/kiosk/src/app/_layout.tsx`
...
**Files:**
- Create: `app/kiosk/docs/workstation-test-plan.md`
