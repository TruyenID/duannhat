...
func TestSplitState_IsSplitCoversByAmount(t *testing.T) {
	...
	if (splitState{splitMode: "even"}).isByAmount() {
...
func TestFormatPaidTicket_ByAmountRendersLabelAndNoItems(t *testing.T) {
	...
	// No title header any more (2026-08-17) — `TestBillSlips_CarryNoTitleAtAll`
	// owns that absence. What this test is really about is the by_amount SHARE
