...
import type { MenuPromotionFilters, MenuPromotionBaseServiceType } from "./MenuPromotionService";
import type { createMenuPromotionQueryKeys } from "./MenuPromotionQueryKeys";

export function createMenuPromotionBaseHooks(
  service: MenuPromotionBaseServiceType,
  keys: ReturnType<typeof createMenuPromotionQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: MenuPromotionFilters = {}) =>
      useQuery({
