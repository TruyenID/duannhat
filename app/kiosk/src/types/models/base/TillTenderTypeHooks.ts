...
import type { TillTenderTypeFilters, TillTenderTypeBaseServiceType } from "./TillTenderTypeService";
import type { createTillTenderTypeQueryKeys } from "./TillTenderTypeQueryKeys";

export function createTillTenderTypeBaseHooks(
  service: TillTenderTypeBaseServiceType,
  keys: ReturnType<typeof createTillTenderTypeQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: TillTenderTypeFilters = {}) =>
      useQuery({
