...
import type { CouponFilters, CouponBaseServiceType } from "./CouponService";
import type { createCouponQueryKeys } from "./CouponQueryKeys";

export function createCouponBaseHooks(
  service: CouponBaseServiceType,
  keys: ReturnType<typeof createCouponQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: CouponFilters = {}) =>
      useQuery({
