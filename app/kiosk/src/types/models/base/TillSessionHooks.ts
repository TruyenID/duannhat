...
import type { TillSessionFilters, TillSessionBaseServiceType } from "./TillSessionService";
import type { createTillSessionQueryKeys } from "./TillSessionQueryKeys";

export function createTillSessionBaseHooks(
  service: TillSessionBaseServiceType,
  keys: ReturnType<typeof createTillSessionQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: TillSessionFilters = {}) =>
      useQuery({
