 ...
 *
 * Returns nothing: TanStack Query v5's `setEventListener` is void and owns the
 * unsubscribe itself. Declaring `() => void` here made the file fail to
 * compile, and any caller that trusted the annotation would have called
 * `undefined()` at teardown — there are none today.
 */
