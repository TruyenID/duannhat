...
This app lives in-tree in the TempoFast monorepo at `app/kiosk/` (the former `godx-jp/godx-tempo-kiosk-app` repo is archived read-only). See the umbrella `CLAUDE.md` for development workflow and Docker setup.
