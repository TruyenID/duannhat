...
export default function BillScreen() {
  ...
  const handleContinue = () => {
    ...
    // #2860 — không còn ánh xạ: một từ vựng cho cả hai đầu. Chỗ này giờ chỉ
    // là "đơn đã chốt chế độ nào thì kiosk mở đúng luồng đó".
    if (order.split_mode === "even") {
      setSplitMode("even");
