...
export default function CardPaymentScreen() {
  ...
  const sendToTerminal = useCallback(() => {
    devLog('[Card] sendToTerminal called, pending:', pendingPaymentRef.current, 'initiated:', paymentInitiated.current);
  ...
  const navigateSuccess = useCallback(() => {
    ...
    recordPayment({
      ...
      method: (paymentFlowState.selectedOption?.route ?? 'card') as PaymentMethod,
