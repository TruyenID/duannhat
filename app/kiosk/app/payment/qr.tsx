...
export default function QRPaymentScreen() {
  ...
  const sendToTerminal = useCallback(() => {
    devLog('[QR] sendToTerminal called, pending:', pendingPaymentRef.current, 'initiated:', paymentInitiated.current);
  ...
  useEffect(() => {
    devLog('[QR] useEffect check: hasTerminal:', hasTerminal, 'pending:', pendingPaymentRef.current, 'initiated:', paymentInitiated.current);
  ...
  const navigateSuccess = useCallback(() => {
    ...
    recordPayment({
      ...
      method: (paymentFlowState.selectedOption?.route ?? 'qr') as PaymentMethod,
