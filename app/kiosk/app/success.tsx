...
export default function SuccessScreen() {
  ...
  // The workstation is the single print authority. For a cloud-confirmed kiosk
  // payment it prints the receipt when the paid order syncs down from Cloud
  // (workstation issue #456). The kiosk must NOT drive its own print — doing so
  // duplicated the slip (one immediate kiosk-driven print + one delayed
  // workstation sync-down print). Reprint stays on-demand via the button below.
