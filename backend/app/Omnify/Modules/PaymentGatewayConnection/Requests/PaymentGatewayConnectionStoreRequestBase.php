...
class PaymentGatewayConnectionStoreRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'owner_branch_key' => ['required', 'string', 'uuid'],
            'identity_brand_id' => ['required', 'string', 'uuid'],
            'owner_scope' => ['required', 'string'],
            'brand_owner_org_unit_id' => ['required', 'string', 'uuid'],
