...
class CouponRedemptionStoreRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'discount_applied_amount' => ['required', 'numeric'],
            'coupon_snapshot' => ['required', 'array'],
            'redeemed_at' => ['required', 'date'],
            'released_at' => ['nullable', 'date'],
            'redeemed_via' => ['required', 'string', 'max:20'],
