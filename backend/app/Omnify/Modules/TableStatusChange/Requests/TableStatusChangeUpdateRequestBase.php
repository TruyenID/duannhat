...
namespace App\Omnify\Modules\TableStatusChange\Requests;
...
class TableStatusChangeUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'changed_by_id' => ['sometimes', 'string', 'uuid'],
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = TableStatusChangeLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
