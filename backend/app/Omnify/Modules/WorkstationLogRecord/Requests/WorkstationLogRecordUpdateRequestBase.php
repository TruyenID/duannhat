...
namespace App\Omnify\Modules\WorkstationLogRecord\Requests;
...
class WorkstationLogRecordUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = WorkstationLogRecordLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
