...
namespace App\Omnify\Modules\StockCountItem\Requests;
...
class StockCountItemUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = StockCountItemLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
