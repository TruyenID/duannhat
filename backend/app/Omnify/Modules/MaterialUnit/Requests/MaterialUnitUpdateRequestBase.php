...
namespace App\Omnify\Modules\MaterialUnit\Requests;
...
class MaterialUnitUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = MaterialUnitLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
