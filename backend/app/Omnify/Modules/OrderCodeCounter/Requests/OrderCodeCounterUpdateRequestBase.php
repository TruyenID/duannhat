...
namespace App\Omnify\Modules\OrderCodeCounter\Requests;
...
class OrderCodeCounterUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = OrderCodeCounterLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
