...
namespace App\Omnify\Modules\Denomination\Requests;
...
class DenominationUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = DenominationLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
