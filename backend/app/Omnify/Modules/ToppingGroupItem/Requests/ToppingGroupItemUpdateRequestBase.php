...
namespace App\Omnify\Modules\ToppingGroupItem\Requests;
...
class ToppingGroupItemUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = ToppingGroupItemLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
