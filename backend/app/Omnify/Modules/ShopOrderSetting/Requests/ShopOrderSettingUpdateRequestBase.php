...
class ShopOrderSettingUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'service_charge_rate' => ['sometimes', 'numeric'],
            'prices_include_tax' => ['sometimes', 'boolean'],
            'service_charge_tax_rate' => ['sometimes', 'numeric'],
            ...
            'split_bill_rounding_mode' => ['sometimes', 'string', 'max:16'],
            'allow_item_edit_any_status' => ['sometimes', 'boolean'],
            'item_voidable_statuses' => ['nullable', 'array'],
            'stock_deduction_timing' => ['sometimes', 'string'],
            ...
            'manual_discount_max_percent' => ['sometimes', 'numeric'],
