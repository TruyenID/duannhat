...
class BrandOrderPolicyStoreRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'default_prep_before_payment' => ['required', 'boolean'],
            'default_prep_minutes_per_item' => ['nullable', 'integer'],
            'allow_shop_edit_hq_tables' => ['required', 'boolean'],
            'cash_variance_tolerance_minor' => ['required', 'integer'],
            'brand_id' => ['required', 'uuid', 'exists:brands,id'],
            'organization_id' => ['required', 'uuid', 'exists:organizations,id'],
            'default_confirmation_timeout_minutes' => ['required', 'integer'],
            'default_table_status_after_payment' => ['required', 'string', 'max:16'],
        ];
    }
