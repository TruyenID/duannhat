...
class WorkstationLogRequestStoreRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'max_records' => ['required', 'integer'],
            'status' => ['required', 'string'],
            'expires_at' => ['required', 'date'],
            'fulfilled_at' => ['nullable', 'date'],
            'received_count' => ['required', 'integer'],
            'rejected_count' => ['required', 'integer'],
        ];
    }
