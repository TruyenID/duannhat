...
namespace App\Omnify\Modules\RoleUserPivot\Requests;
...
class RoleUserPivotUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = RoleUserPivotLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
