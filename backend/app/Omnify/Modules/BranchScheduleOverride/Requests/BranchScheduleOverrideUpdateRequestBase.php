...
namespace App\Omnify\Modules\BranchScheduleOverride\Requests;
...
class BranchScheduleOverrideUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'menu_schedule_id' => ['sometimes', 'uuid', 'exists:menu_schedules,id'],
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = BranchScheduleOverrideLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
