...
class DevicePaymentOptionUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'shop_payment_option_id' => ['sometimes', 'uuid', 'exists:shop_payment_options,id'],
            'preference' => ['sometimes', 'string', Rule::in(['inherit', 'disabled'])],
