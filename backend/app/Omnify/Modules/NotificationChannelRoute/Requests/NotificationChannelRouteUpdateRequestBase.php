...
namespace App\Omnify\Modules\NotificationChannelRoute\Requests;
...
class NotificationChannelRouteUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = NotificationChannelRouteLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
