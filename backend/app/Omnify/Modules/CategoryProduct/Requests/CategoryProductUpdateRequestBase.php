...
namespace App\Omnify\Modules\CategoryProduct\Requests;
...
class CategoryProductUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = CategoryProductLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
