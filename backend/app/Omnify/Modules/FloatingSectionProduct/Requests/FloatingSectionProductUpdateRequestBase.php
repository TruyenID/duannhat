...
namespace App\Omnify\Modules\FloatingSectionProduct\Requests;
...
class FloatingSectionProductUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = FloatingSectionProductLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
