...
class PrintImageRasterUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'asset_id' => ['sometimes', 'uuid', 'exists:print_image_assets,id'],
            'max_width_dots' => ['sometimes', 'integer'],
            'width_dots' => ['sometimes', 'integer'],
            'height_dots' => ['sometimes', 'integer'],
            'data' => ['sometimes', 'string'],
            'content_hash' => ['sometimes', 'string', 'max:64'],
            'byte_length' => ['sometimes', 'integer'],
        ];
    }
