...
namespace App\Omnify\Modules\MenuPromotionCategory\Requests;
...
class MenuPromotionCategoryUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = MenuPromotionCategoryLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
