...
namespace App\Omnify\Modules\PostPostTag\Requests;
...
class PostPostTagUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = PostPostTagLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
