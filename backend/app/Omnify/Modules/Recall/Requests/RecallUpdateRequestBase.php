...
class RecallUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'recall_code' => ['sometimes', 'string', 'max:50'],
            'root_lot_id' => ['sometimes', 'uuid', 'exists:material_lots,id'],
            'scope_type' => ['sometimes', 'string'],
