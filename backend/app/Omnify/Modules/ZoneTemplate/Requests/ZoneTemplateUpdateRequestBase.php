...
namespace App\Omnify\Modules\ZoneTemplate\Requests;
...
class ZoneTemplateUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = ZoneTemplateLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
