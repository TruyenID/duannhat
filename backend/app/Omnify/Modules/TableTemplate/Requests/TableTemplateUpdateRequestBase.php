...
namespace App\Omnify\Modules\TableTemplate\Requests;
...
class TableTemplateUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'zone_template_id' => ['sometimes', 'uuid', 'exists:zone_templates,id'],
        ];
    }
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = TableTemplateLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
