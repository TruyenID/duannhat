...
class StockTransferItemUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'stock_transfer_id' => ['sometimes', 'uuid', 'exists:stock_transfers,id'],
            'product_sku_id' => ['nullable', 'uuid', 'exists:product_skus,id'],
            'material_id' => ['nullable', 'uuid', 'exists:materials,id'],
            'sent_quantity' => ['sometimes', 'numeric'],
            'sent_base_quantity' => ['sometimes', 'numeric'],
