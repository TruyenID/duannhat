...
namespace App\Omnify\Modules\MenuPromotionProduct\Requests;
...
class MenuPromotionProductUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = MenuPromotionProductLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
