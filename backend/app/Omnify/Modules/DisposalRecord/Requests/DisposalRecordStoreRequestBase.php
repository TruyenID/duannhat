...
class DisposalRecordStoreRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'stock_transaction_item_id' => ['required', 'uuid', 'exists:stock_transaction_items,id'],
            'disposal_reason' => ['required', 'string'],
            'cost_at_disposal' => ['required', 'numeric'],
