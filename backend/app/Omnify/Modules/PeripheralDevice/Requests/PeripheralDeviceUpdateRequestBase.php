...
namespace App\Omnify\Modules\PeripheralDevice\Requests;
...
class PeripheralDeviceUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'registered_by_device_id' => ['nullable', 'uuid', 'exists:devices,id'],
        ];
    }
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = PeripheralDeviceLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
