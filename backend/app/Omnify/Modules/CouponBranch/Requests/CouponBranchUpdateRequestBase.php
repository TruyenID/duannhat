...
namespace App\Omnify\Modules\CouponBranch\Requests;
...
class CouponBranchUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = CouponBranchLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
