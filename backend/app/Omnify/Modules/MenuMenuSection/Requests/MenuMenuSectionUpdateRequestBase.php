...
namespace App\Omnify\Modules\MenuMenuSection\Requests;
...
class MenuMenuSectionUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = MenuMenuSectionLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
