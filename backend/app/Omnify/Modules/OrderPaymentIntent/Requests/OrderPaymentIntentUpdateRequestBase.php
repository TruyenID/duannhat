...
namespace App\Omnify\Modules\OrderPaymentIntent\Requests;
...
class OrderPaymentIntentUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'intent_id' => ['sometimes', 'string', 'max:255'],
        ];
    }
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = OrderPaymentIntentLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
