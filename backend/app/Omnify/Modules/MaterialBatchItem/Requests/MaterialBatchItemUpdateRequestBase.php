...
class MaterialBatchItemUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'material_batch_id' => ['sometimes', 'uuid', 'exists:material_batches,id'],
            'component_type' => ['sometimes', 'string'],
