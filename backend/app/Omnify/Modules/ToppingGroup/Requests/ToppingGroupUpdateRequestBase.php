...
class ToppingGroupUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'price_strategy' => ['sometimes', 'string'],
            'free_quantity' => ['nullable', 'integer'],
            'selection_type' => ['sometimes', 'string'],
            'modifier_type' => ['sometimes', 'string'],
            'min_select' => ['sometimes', 'integer'],
            'max_select' => ['nullable', 'integer'],
            'max_qty_per_item' => ['sometimes', 'integer'],
