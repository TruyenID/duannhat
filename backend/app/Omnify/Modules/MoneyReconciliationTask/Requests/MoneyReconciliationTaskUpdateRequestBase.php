...
class MoneyReconciliationTaskUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'task_type' => ['sometimes', 'string', 'max:40'],
            'subject_type' => ['sometimes', 'string', 'max:40'],
            'subject_id' => ['sometimes', 'string', 'uuid'],
