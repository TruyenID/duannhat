...
namespace App\Omnify\Modules\ExpiryAlert\Requests;
...
class ExpiryAlertUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'threshold_days' => ['sometimes', 'integer'],
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = ExpiryAlertLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
