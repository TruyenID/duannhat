...
namespace App\Omnify\Modules\ProductToppingGroupItemOverride\Requests;
...
class ProductToppingGroupItemOverrideUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = ProductToppingGroupItemOverrideLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
