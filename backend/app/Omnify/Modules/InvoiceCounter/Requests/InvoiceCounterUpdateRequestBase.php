...
namespace App\Omnify\Modules\InvoiceCounter\Requests;
...
class InvoiceCounterUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'year_month' => ['sometimes', 'string', 'max:6'],
            'last_seq' => ['sometimes', 'integer'],
        ];
    }
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = InvoiceCounterLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
