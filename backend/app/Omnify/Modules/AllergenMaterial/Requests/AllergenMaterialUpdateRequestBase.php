...
namespace App\Omnify\Modules\AllergenMaterial\Requests;
...
class AllergenMaterialUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = AllergenMaterialLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
