...
namespace App\Omnify\Modules\RecallAffectedOrder\Requests;
...
class RecallAffectedOrderUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'recall_id' => ['sometimes', 'uuid', 'exists:recalls,id'],
            'customer_order_id' => ['sometimes', 'string', 'uuid'],
            'notification_channel' => ['nullable', 'string', 'max:20'],
            'notified_at' => ['nullable', 'date'],
            'notification_id' => ['nullable', 'string', 'uuid'],
        ];
    }
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = RecallAffectedOrderLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
