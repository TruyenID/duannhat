...
namespace App\Omnify\Modules\NotificationRule\Resources;
...
class NotificationRuleResourceBase extends JsonResource
{
    /**
    ...
    protected function schemaArray(Request $request): array
    {
        return [
            ...
            'trigger_model_type' => $this->trigger_model_type,
            'conditions' => $this->conditions,
            'action' => $this->action,
            'cooldown_minutes' => $this->cooldown_minutes,
            'is_active' => $this->is_active,
            'last_fired_at' => $this->last_fired_at?->toISOString(),
            'fire_count' => $this->fire_count,
