...
namespace App\Omnify\Modules\ToppingGroupItemSku\Requests;
...
class ToppingGroupItemSkuUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = ToppingGroupItemSkuLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
