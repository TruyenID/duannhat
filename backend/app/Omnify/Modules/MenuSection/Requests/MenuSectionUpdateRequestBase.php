...
namespace App\Omnify\Modules\MenuSection\Requests;
...
class MenuSectionUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = MenuSectionLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
