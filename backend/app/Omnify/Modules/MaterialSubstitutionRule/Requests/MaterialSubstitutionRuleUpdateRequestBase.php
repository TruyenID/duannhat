...
namespace App\Omnify\Modules\MaterialSubstitutionRule\Requests;
...
class MaterialSubstitutionRuleUpdateRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'primary_material_id' => ['sometimes', 'uuid', 'exists:materials,id'],
            'substitute_material_id' => ['sometimes', 'uuid', 'exists:materials,id'],
            'conversion_factor' => ['sometimes', 'numeric'],
            'priority' => ['sometimes', 'integer'],
            'is_active' => ['sometimes', 'boolean'],
            'auto_substitute' => ['sometimes', 'boolean'],
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = MaterialSubstitutionRuleLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
