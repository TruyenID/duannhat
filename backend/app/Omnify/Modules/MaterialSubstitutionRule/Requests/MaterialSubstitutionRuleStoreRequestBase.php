...
class MaterialSubstitutionRuleStoreRequestBase extends FormRequest
{
    /**
    ...
    {
        return [
            'primary_material_id' => ['required', 'uuid', 'exists:materials,id'],
            'substitute_material_id' => ['required', 'uuid', 'exists:materials,id'],
            'conversion_factor' => ['required', 'numeric'],
            'priority' => ['required', 'integer'],
            'is_active' => ['required', 'boolean'],
            'auto_substitute' => ['required', 'boolean'],
