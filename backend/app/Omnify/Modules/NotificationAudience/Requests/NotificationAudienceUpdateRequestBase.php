...
namespace App\Omnify\Modules\NotificationAudience\Requests;
...
class NotificationAudienceUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = NotificationAudienceLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
