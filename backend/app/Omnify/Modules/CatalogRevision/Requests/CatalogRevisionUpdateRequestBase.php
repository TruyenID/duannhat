...
namespace App\Omnify\Modules\CatalogRevision\Requests;
...
class CatalogRevisionUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'snapshot_hash' => ['sometimes', 'string', 'max:64'],
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = CatalogRevisionLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
