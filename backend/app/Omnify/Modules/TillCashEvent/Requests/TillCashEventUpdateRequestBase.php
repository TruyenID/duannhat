...
namespace App\Omnify\Modules\TillCashEvent\Requests;
...
class TillCashEventUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'manual_adjustment' => ['sometimes', 'boolean'],
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = TillCashEventLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
