...
namespace App\Omnify\Modules\PostBranch\Requests;
...
class PostBranchUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaAttributes(): array
    {
        ...
        $propertyNames = PostBranchLocales::PROPERTY_DISPLAY_NAMES;
        $attributes = [];
