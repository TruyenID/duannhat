...
class PointRewardUpdateRequestBase extends FormRequest
{
    /**
    ...
    protected function schemaRules(): array
    {
        return [
            ...
            'cost_points' => ['sometimes', 'integer'],
            'discount_type' => ['sometimes', 'string'],
            'discount_value' => ['sometimes', 'numeric'],
            'max_discount_cap' => ['nullable', 'numeric'],
            'min_order_subtotal' => ['sometimes', 'numeric'],
            'valid_days' => ['sometimes', 'integer'],
            'stock_quantity' => ['nullable', 'integer'],
            'redeemed_count' => ['sometimes', 'integer'],
            'service_condition' => ['sometimes', 'string'],
