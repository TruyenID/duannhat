...
/**
 * TillSettlementKind — Settlement Kind
 *
 ...
 * @generated by omnify
 */
enum TillSettlementKindEnum: string
{
     ...
     */
    public const LABELS = [
        'handover' => ['en' => 'Handover', 'ja' => '引き継ぎ', 'vi' => 'Bàn giao ca'],
        'final' => ['en' => 'Final close', 'ja' => '精算（最終）', 'vi' => 'Kết ca cuối'],
    ];
