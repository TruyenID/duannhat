...
/**
 * PaymentGatewayEnvironment — Payment Gateway Environment
 *
 ...
 * @generated by omnify
 */
enum PaymentGatewayEnvironmentEnum: string
{
    case Local = 'local';
     ...
     */
    public const LABELS = [
        'local' => ['en' => 'Local', 'ja' => 'ローカル', 'vi' => 'Cục bộ'],
        'sandbox' => ['en' => 'Sandbox', 'ja' => 'サンドボックス', 'vi' => 'Sandbox'],
        'test' => ['en' => 'Test', 'ja' => 'テスト', 'vi' => 'Kiểm thử'],
        'live' => ['en' => 'Live', 'ja' => '本番', 'vi' => 'Chính thức'],
    ];
