...
/**
 * PrinterConnectionType — Connection Type
 *
 ...
 * @generated by omnify
 */
enum PrinterConnectionTypeEnum: string
{
     ...
     */
    public const LABELS = [
        'network' => ['en' => 'Network (TCP)', 'ja' => 'ネットワーク（TCP）', 'vi' => 'Mạng LAN (TCP)'],
        'usb' => ['en' => 'USB', 'ja' => 'USB', 'vi' => 'USB'],
    ];
