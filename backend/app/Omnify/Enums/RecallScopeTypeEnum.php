...
/**
 * RecallScopeType — Recall Scope Type
 *
 ...
 * @generated by omnify
 */
enum RecallScopeTypeEnum: string
{
    case Lot = 'lot';
    case SupplierLot = 'supplier_lot';
     ...
     */
    public const LABELS = [
        'lot' => ['en' => 'Single Lot', 'ja' => 'ロット', 'vi' => 'Lô đơn'],
        'supplier_lot' => ['en' => 'Supplier Lot', 'ja' => '仕入先ロット', 'vi' => 'Lô NCC'],
        'material' => ['en' => 'Material', 'ja' => '材料', 'vi' => 'Nguyên liệu'],
    ];
