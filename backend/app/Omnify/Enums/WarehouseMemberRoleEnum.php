...
/**
 * WarehouseMemberRole — Warehouse Member Role
 *
 ...
 * @generated by omnify
 */
enum WarehouseMemberRoleEnum: string
{
     ...
     */
    public const LABELS = [
        'manager' => ['en' => 'Warehouse Manager', 'ja' => '倉庫マネージャー', 'vi' => 'Quản lý kho'],
        'staff' => ['en' => 'Warehouse Staff', 'ja' => '倉庫スタッフ', 'vi' => 'Nhân viên kho'],
    ];
