...
/**
 * MenuScheduleRecurrence — Recurrence Kind
 *
 ...
 * @generated by omnify
 */
enum MenuScheduleRecurrenceEnum: string
{
    case Weekly = 'Weekly';
     ...
     */
    public const LABELS = [
        'Weekly' => ['en' => 'Weekly (by weekday)', 'ja' => '毎週（曜日指定）', 'vi' => 'Hàng tuần (theo thứ)'],
        'Monthly' => ['en' => 'Monthly (by day of month)', 'ja' => '毎月（日付指定）', 'vi' => 'Hàng tháng (theo ngày)'],
        'SpecificDates' => ['en' => 'Specific dates only', 'ja' => '特定日のみ', 'vi' => 'Ngày cụ thể'],
    ];
