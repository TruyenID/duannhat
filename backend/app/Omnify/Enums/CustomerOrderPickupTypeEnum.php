...
/**
 * CustomerOrderPickupType — Pickup Type
 *
 ...
 * @generated by omnify
 */
enum CustomerOrderPickupTypeEnum: string
{
     ...
     */
    public const LABELS = [
        'immediate' => ['en' => 'Immediate', 'ja' => 'すぐに', 'vi' => 'Lấy ngay'],
        'scheduled' => ['en' => 'Scheduled', 'ja' => '予約', 'vi' => 'Hẹn giờ'],
    ];
