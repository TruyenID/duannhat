...
/**
 * StockCountScope — Stock Count Scope
 *
 ...
 * @generated by omnify
 */
enum StockCountScopeEnum: string
{
    case Full = 'full';
     ...
     */
    public const LABELS = [
        'full' => ['en' => 'Full Count', 'ja' => '全品棚卸', 'vi' => 'Kiểm kê toàn bộ'],
        'partial' => ['en' => 'Partial Count', 'ja' => '一部棚卸', 'vi' => 'Kiểm kê một phần'],
    ];
