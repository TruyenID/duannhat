...
/**
 * PaymentConnectionOwnerScope — Payment Connection Owner Scope
 *
 ...
 * @generated by omnify
 */
enum PaymentConnectionOwnerScopeEnum: string
{
    case Hq = 'hq';
     ...
     */
    public const LABELS = [
        'hq' => ['en' => 'Headquarters', 'ja' => '本部', 'vi' => 'Trụ sở chính'],
        'franchise' => ['en' => 'Franchise Operator', 'ja' => 'フランチャイズ運営者', 'vi' => 'Đơn vị nhượng quyền'],
    ];
