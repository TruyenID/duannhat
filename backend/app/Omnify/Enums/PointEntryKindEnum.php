...
/**
 * PointEntryKind — Point Entry Kind
 *
 ...
 * @generated by omnify
 */
enum PointEntryKindEnum: string
{
    case Earn = 'earn';
    case Redeem = 'redeem';
    case Revoke = 'revoke';
     ...
     */
    public const LABELS = [
        'earn' => ['en' => 'Earned', 'ja' => '獲得', 'vi' => 'Tích điểm'],
        'redeem' => ['en' => 'Redeemed', 'ja' => '交換', 'vi' => 'Đổi điểm'],
        'revoke' => ['en' => 'Revoked', 'ja' => '取消', 'vi' => 'Thu hồi'],
        'adjust' => ['en' => 'Adjusted', 'ja' => '調整', 'vi' => 'Điều chỉnh'],
        'expire' => ['en' => 'Expired', 'ja' => '失効', 'vi' => 'Hết hạn'],
    ];
