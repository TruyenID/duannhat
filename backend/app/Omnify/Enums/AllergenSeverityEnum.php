...
/**
 * AllergenSeverity — Allergen Severity
 *
 ...
 * @generated by omnify
 */
enum AllergenSeverityEnum: string
{
     ...
     */
    public const LABELS = [
        'mandatory' => ['en' => 'Mandatory', 'ja' => '表示義務', 'vi' => 'Bắt buộc'],
        'recommended' => ['en' => 'Recommended', 'ja' => '表示推奨', 'vi' => 'Khuyến nghị'],
    ];
