...
/**
 * StockAlertType — Stock Alert Type
 *
 ...
 * @generated by omnify
 */
enum StockAlertTypeEnum: string
{
     ...
     */
    public const LABELS = [
        'low_stock' => ['en' => 'Low Stock', 'ja' => '在庫不足', 'vi' => 'Sắp hết hàng'],
        'out_of_stock' => ['en' => 'Out of Stock', 'ja' => '在庫切れ', 'vi' => 'Hết hàng'],
    ];
