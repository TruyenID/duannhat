 ...
 * @generated by omnify
 */
enum TaxClassificationEnum: string
{
     ...
     */
    public const LABELS = [
        'taxable' => ['en' => 'Taxable', 'ja' => '課税', 'vi' => 'Chịu thuế'],
        'exempt' => ['en' => 'Exempt', 'ja' => '非課税', 'vi' => 'Không chịu thuế'],
        'out_of_scope' => ['en' => 'Out of Scope', 'ja' => '不課税', 'vi' => 'Không phải kê khai'],
        'zero_rated' => ['en' => 'Zero-rated', 'ja' => '免税', 'vi' => 'Thuế suất 0%'],
    ];
