...
/**
 * MaterialLotSource — Material Lot Source
 *
 ...
 * @generated by omnify
 */
enum MaterialLotSourceEnum: string
{
     ...
     */
    public const LABELS = [
        'inbound' => ['en' => 'Inbound', 'ja' => '仕入', 'vi' => 'Nhập từ NCC'],
        'production' => ['en' => 'Production', 'ja' => '生産', 'vi' => 'Từ batch sản xuất'],
    ];
