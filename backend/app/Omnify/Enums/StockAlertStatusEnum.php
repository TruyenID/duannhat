...
/**
 * StockAlertStatus — Stock Alert Status
 *
 ...
 * @generated by omnify
 */
enum StockAlertStatusEnum: string
{
    case Active = 'active';
     ...
     */
    public const LABELS = [
        'active' => ['en' => 'Active', 'ja' => 'アクティブ', 'vi' => 'Đang cảnh báo'],
        'resolved' => ['en' => 'Resolved', 'ja' => '解決済み', 'vi' => 'Đã giải quyết'],
    ];
