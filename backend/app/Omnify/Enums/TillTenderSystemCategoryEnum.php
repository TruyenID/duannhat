...
/**
 * TillTenderSystemCategory — Till Tender Category
 *
 ...
 * @generated by omnify
 */
enum TillTenderSystemCategoryEnum: string
{
    case Cash = 'cash';
    case Card = 'card';
    case Qr = 'qr';
    ...
    public const LABELS = [
        ...
        'card' => ['en' => 'Card', 'ja' => 'クレジット', 'vi' => 'Thẻ'],
        'qr' => ['en' => 'QR Payment', 'ja' => 'QR決済', 'vi' => 'QR'],
        'emoney' => ['en' => 'E-Money', 'ja' => '電子マネー', 'vi' => 'Tiền điện tử'],
    ];
