...
/**
 * MenuItemAvailability — Menu Item Availability
 *
...
enum MenuItemAvailabilityEnum: string
{
     ...
     */
    public const LABELS = [
        'Available' => ['en' => 'Available', 'ja' => '在庫あり', 'vi' => 'Còn hàng'],
        'Unavailable' => ['en' => 'Unavailable', 'ja' => '一時的に利用不可', 'vi' => 'Tạm ngưng'],
        'OutOfStock' => ['en' => 'Out of Stock', 'ja' => '在庫切れ', 'vi' => 'Hết hàng'],
    ];
