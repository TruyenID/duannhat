...
enum MenuStatusEnum: string
{
     ...
     */
    public const LABELS = [
        'Draft' => ['en' => 'Draft', 'ja' => '下書き', 'vi' => 'Bản nháp'],
        'Pending' => ['en' => 'Pending', 'ja' => '承認待ち', 'vi' => 'Chờ duyệt'],
        'Approved' => ['en' => 'Approved', 'ja' => '承認済み', 'vi' => 'Đã duyệt'],
        'Active' => ['en' => 'Active', 'ja' => '有効', 'vi' => 'Đang hoạt động'],
        'Inactive' => ['en' => 'Inactive', 'ja' => '無効', 'vi' => 'Tạm dừng'],
        'Rejected' => ['en' => 'Rejected', 'ja' => '却下', 'vi' => 'Từ chối'],
    ];
