...
use App\Omnify\Modules\ProductType\Resources\ProductTypeResourceBase;
use Illuminate\Http\Request;

/**
 * ProductTypeResource — add project-specific serialization here.
 *
 * Inherited from base:
 *   - toArray(Request \$request): array  (returns schemaArray(\$request) — override to add fields)
 */
class ProductTypeResource extends ProductTypeResourceBase
{
