...
/** Tracks provider mutation fingerprints so retries stay safe before Stripe replay. */
final class StripeMutationIdempotency
{
    ...
    public function payment(
        ...
        /** @var array{fingerprint: string, provider_id: string}|null $cached */
        ...
        if ($cached !== null) {
            ...
            return $retrieve($cached['provider_id']);
        }
        ...
        Cache::put($cacheKey, [
            ...
            'provider_id' => $result->payment->value,
        ], self::TTL_SECONDS);
    ...
    public function refund(
        ...
        Cache::put($cacheKey, [
            'fingerprint' => $fingerprint,
            'provider_id' => $result->refund->value,
        ], self::TTL_SECONDS);
    ...
    {
        return 'stripe_mutation:'.hash('sha256', "{$connectionId}|{$operation}|{$idempotencyKey}");
    }
