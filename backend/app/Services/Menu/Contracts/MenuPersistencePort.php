...
{
    public function insertMenu(CreateMenuCommand $command): MutationResult;
    ...
    public function insertSchedule(CreateMenuScheduleCommand $command): MutationResult;

    public function replaceSchedule(UpdateMenuScheduleCommand $command): MutationResult;

    public function removeSchedule(DeleteMenuScheduleCommand $command): MutationResult;
    ...
    public function insertSection(CreateMenuSectionCommand $command): MutationResult;
    ...
    public function applyRevision(ReviseMenuCommand $command): MutationResult;
    ...
    public function insertFloatingSection(CreateFloatingMenuSectionCommand $command): MutationResult;
    ...
    public function insertFloatingSchedule(CreateFloatingMenuScheduleCommand $command): MutationResult;
    ...
    public function markSubmitted(MenuLifecycleCommand $command): MutationResult;

    public function markApproved(MenuLifecycleCommand $command): MutationResult;

    public function markRejected(MenuLifecycleCommand $command): MutationResult;

    public function markActive(MenuLifecycleCommand $command): MutationResult;

    public function markInactive(MenuLifecycleCommand $command): MutationResult;

    public function markArchived(MenuLifecycleCommand $command): MutationResult;

    public function markRestored(MenuLifecycleCommand $command): MutationResult;
}
