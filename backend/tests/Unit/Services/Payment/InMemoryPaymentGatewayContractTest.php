...
final class InMemoryPaymentGatewayContractTest extends PaymentGatewayContractTestCase
{
    ...
    protected function invalidWebhook(GatewayConnectionData $connection, string $correlationId): VerifyWebhookCommand
    {
        return new VerifyWebhookCommand(
            $connection,
            '{"provider":"invalid-signature-fixture"}',
            ['Provider-Signature' => 'wrong-signature'],
            $correlationId,
        );
    }
}
