...
import type { AllergenFilters, AllergenBaseServiceType } from "./AllergenService";
import type { createAllergenQueryKeys } from "./AllergenQueryKeys";

export function createAllergenBaseHooks(
  service: AllergenBaseServiceType,
  keys: ReturnType<typeof createAllergenQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: AllergenFilters = {}) =>
      useQuery({
