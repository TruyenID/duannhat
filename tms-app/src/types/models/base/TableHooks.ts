...
import type { TableFilters, TableBaseServiceType } from "./TableService";
import type { createTableQueryKeys } from "./TableQueryKeys";

export function createTableBaseHooks(
  service: TableBaseServiceType,
  keys: ReturnType<typeof createTableQueryKeys>,
  entityLabel: string,
) {
  return {
    useList: (slug: string, filters: TableFilters = {}) =>
      useQuery({
