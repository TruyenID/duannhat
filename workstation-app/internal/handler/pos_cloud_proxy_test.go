...
func TestPosCloudProxy_ForwardsUnmirroredPath(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/api/v1/pos/orders/o1/apply-coupon", nil)
	...
	if resp["path"] != "/api/v1/pos/orders/o1/apply-coupon" {
...
func TestPosCloudProxy_CorsPreflightAdvertisesShopSlug(t *testing.T) {
	...
	req := httptest.NewRequest("OPTIONS", "/api/v1/pos/orders/o1/apply-coupon", nil)
	req.Header.Set("Origin", "http://localhost:5440")
...
func TestPosCloudProxy_BadGatewayWhenCloudUnreachable(t *testing.T) {
	...
	req2 := httptest.NewRequest("GET", "/api/v1/pos/orders/o1/apply-coupon", nil)
