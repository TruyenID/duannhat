...
func (s *Server) handleLocalPosOrders(w http.ResponseWriter, r *http.Request) {
	...
	for i := range orders {
		...
		shaped = append(shaped, s.shapeOrderForResponse(r, &orders[i]))
	}
