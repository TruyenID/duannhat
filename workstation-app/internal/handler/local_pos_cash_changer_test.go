...
func TestCashChangerHTTP_CollectFlow(t *testing.T) {
	...
	s.handleCashChangerCollect(rr, req)
...
func TestCashChangerHTTP_ConfigFromRegistry(t *testing.T) {
	...
	rr := httptest.NewRecorder()
	s.handleCashChangerCollect(rr, httptest.NewRequest(http.MethodPost,
...
func TestCashChangerHTTP_Busy409(t *testing.T) {
	...
	s.handleCashChangerCollect(first, httptest.NewRequest(http.MethodPost,
		"/api/v1/pos/cash-changer/collect", strings.NewReader(`{"order_id":"o1"}`)))
	...
	s.handleCashChangerCollect(second, httptest.NewRequest(http.MethodPost,
		"/api/v1/pos/cash-changer/collect", strings.NewReader(`{"order_id":"o1"}`)))
