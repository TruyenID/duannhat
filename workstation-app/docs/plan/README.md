...
| Bảng `orders`, `order_items`, `menu_items` | [`migrations/001_initial_schema.sql`](../../migrations/001_initial_schema.sql) | Có |
| Bảng `sync_queue` | [`migrations/001_initial_schema.sql`](../../migrations/001_initial_schema.sql) | Có |
| Settings table (`device_token`, `cloud_api_url`) | [`migrations/002_device_auth.sql`](../../migrations/002_device_auth.sql) | Có |
