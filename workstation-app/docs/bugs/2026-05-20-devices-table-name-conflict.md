...
|---|---|---|---|
| Hand-written (Sprint 0) | [migrations/001_initial_schema.sql:62-73](../../migrations/001_initial_schema.sql#L62-L73) | `id, type, name, connection_type, address, config, is_active, last_seen_at, ...` | **Phần cứng máy in** (ESC/POS printers USB/TCP) — printer.Manager owns |
