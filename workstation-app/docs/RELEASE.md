...
This repo is a submodule of the tempo umbrella, whose `pnpm-workspace.yaml` does
not list `workstation-app/frontend`. A plain `pnpm install` walks up, resolves the
